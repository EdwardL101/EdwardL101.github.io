...
to setup-globals
  set infection-chance 75    ;; if you have unprotected sex with an infected partner,
                             ;; you have a 75% chance of being infected
  set symptoms-show 300.0    ;; symptoms show up 300 weeks after infection
...
to setup-people
  create-turtles initial-people
    [ setxy random-xcor random-ycor
      ...
      ;; 25% of the people start out infected, but they don't know it
      set infected? (who < initial-people * 0.25)
      if infected?
...
;; pink is not infected
;; yellow is infected but doesn't know it
;; blue is infected and knows it
  ...
  if potential-partner != nobody
    [ if random-float 10.0 < [coupling-tendency] of potential-partner
      [ set partner potential-partner
        ...
        set pcolor red - 3
        ask (patch-at -1 0) [ set pcolor red - 3 ] ] ]
end
...
PENS
"HIV-" 1 0 -10899396 true "" "plot count turtles with [not infected?]"
"HIV+" 1 0 -2674135 true "" "plot count turtles with [known?]"
"HIV?" 1 0 -13345367 true "" "plot count turtles with [infected?] - count turtles with [known?]"
@#$#@#$#@
## WHAT IS IT?
